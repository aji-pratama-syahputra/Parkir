...
Begin VB.Form frmLapTerimaBln1 
   BackColor       =   &H00E6F1EF&
   ...
   ClientTop       =   435
   ClientWidth     =   7125
   Icon            =   "frmLapTerimaBln1.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Image Image1 
      Height          =   735
      Left            =   210
      Picture         =   "frmLapTerimaBln1.frx":2CFA
      Top             =   5595
      Width           =   1800
   End
End
Attribute VB_Name = "frmLapTerimaBln1"
...
Private Sub cmdOK_Click()
    ...
    Unload Me
    Unload frmLapTerimaBln2
    frmLapTerimaBln2.Show
