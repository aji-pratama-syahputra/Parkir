...
Begin VB.Form frmLapSisaParkir2 
   BackColor       =   &H00E6F1EF&
   ...
   ClientTop       =   450
   ClientWidth     =   10320
   Icon            =   "frmLapSisaParkir2.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MDIChild        =   -1  'True
   ScaleHeight     =   9315
   ...
   End
End
Attribute VB_Name = "frmLapSisaParkir2"
...
Private Sub Form_Load()
    ...
    'Sumber rpt
    Set cRep = cApp.OpenReport(App.Path & "\Report\DaftarSisaKendaraan.rpt")
            
    'SQL Laporan
    cF = "Select Tanggal, NoPlat, JamMasuk, OpMasuk, " & _
         "JamKeluar, OpKeluar, Biaya, Keterangan From Parking " & _
         "Where Tanggal = " & FormatTgl(Tgl1) & " and JamKeluar Is Null"
    ...
    If rsCetak.RecordCount > 0 Then
        ...
        'Filter Tanggal
        cRep.FormulaFields(1).Text = "'" & Format(Tgl1, "dd/mm/yyyy") & "'"
