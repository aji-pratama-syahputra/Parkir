...
Begin VB.Form frmLapTerimaTgl2 
   BackColor       =   &H00E6F1EF&
   ...
   ClientTop       =   450
   ClientWidth     =   10320
   Icon            =   "frmLapTerimaTgl2.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MDIChild        =   -1  'True
   ScaleHeight     =   9315
   ...
   End
End
Attribute VB_Name = "frmLapTerimaTgl2"
...
Private Sub Form_Load()
    ...
    'Sumber rpt
    Set cRep = cApp.OpenReport(App.Path & "\Report\TerimaPerTgl.rpt")
    ...
    If rsCetak.RecordCount > 0 Then
        ...
        If BTgl Then
            'Periode
            cRep.FormulaFields(1).Text = "'" & Format(Tgl1, "dd/mm/yyyy") & "  s/d  " & _
                                          Format(Tgl2, "dd/mm/yyyy") & "'"
        Else
            'Periode
