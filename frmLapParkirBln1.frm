...
Begin VB.Form frmLapParkirBln1 
   BackColor       =   &H00E6F1EF&
   ...
   ClientTop       =   435
   ClientWidth     =   7125
   Icon            =   "frmLapParkirBln1.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.PictureBox Picture1 
      ...
      Width           =   10050
   End
   Begin MSComCtl2.DTPicker DTPicker22 
      Height          =   360
      Left            =   3990
      TabIndex        =   20
      Top             =   1395
   ...
   Begin VB.Image Image1 
      Height          =   735
      Left            =   210
      Picture         =   "frmLapParkirBln1.frx":2CFA
      Top             =   5595
      Width           =   1800
   End
End
Attribute VB_Name = "frmLapParkirBln1"
...
Private Sub cmdOK_Click()
    ...
    If chkTgl.Value And (DTPicker1.Value > DTPicker2.Value) Then
        MsgBox "Filter bulan salah !", vbCritical
        Exit Sub
    ...
    DTPicker22.Value = DTPicker2.Value
    DTPicker22.Value = DTPicker22.Value + 30
    DTPicker22.Day = 1
    DTPicker22.Value = DTPicker22.Value - 1
    Tgl2 = DTPicker22.Value
    ...
    Unload Me
    Unload frmLapParkirBln2
    frmLapParkirBln2.Show
