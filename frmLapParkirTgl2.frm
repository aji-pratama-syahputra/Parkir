...
Begin VB.Form frmLapParkirTgl2 
   BackColor       =   &H00E6F1EF&
   ...
   ClientTop       =   450
   ClientWidth     =   10320
   Icon            =   "frmLapParkirTgl2.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MDIChild        =   -1  'True
   ScaleHeight     =   9315
   ...
   End
End
Attribute VB_Name = "frmLapParkirTgl2"
...
Private Sub Form_Load()
    ...
    'Sumber rpt
    Set cRep = cApp.OpenReport(App.Path & "\Report\ParkirPerTgl.rpt")
