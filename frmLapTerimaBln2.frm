...
Begin VB.Form frmLapTerimaBln2 
   BackColor       =   &H00E6F1EF&
   ...
   ClientTop       =   450
   ClientWidth     =   10320
   Icon            =   "frmLapTerimaBln2.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MDIChild        =   -1  'True
   ScaleHeight     =   9315
   ...
   End
End
Attribute VB_Name = "frmLapTerimaBln2"
...
Private Sub Form_Load()
    ...
    'Sumber rpt
    Set cRep = cApp.OpenReport(App.Path & "\Report\TerimaPerBln.rpt")
